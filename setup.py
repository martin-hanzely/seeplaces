...
setup(
    ...
    description="Python wrapper for seeplaces.com excursion api.",  # Optional
    ...
    url="https://github.com/martin-hanzely/seeplaces",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="Martin Hanzely",  # Optional
    ...
    install_requires=["certifi==2022.9.24; python_version >= '3.6'", "charset-normalizer==2.1.1; python_full_version >= '3.6.0'", "idna==3.4; python_version >= '3.5'", 'requests==2.28.1', "urllib3==1.26.13; python_version >= '2.7' and python_version not in '3.0, 3.1, 3.2, 3.3, 3.4, 3.5'"],  # Optional
    ...
    project_urls={  # Optional
        "Bug Reports": "https://github.com/martin-hanzely/seeplaces/issues",
        # "Funding": "https://donate.pypi.org",
        # "Say Thanks!": "http://saythanks.io/to/example",
        "Source": "https://github.com/martin-hanzely/seeplaces/",
    },
)
